...
//BLUFOR =======================================================================
[{
    ["WAVERESPAWNSTATUSBLU",[WEST] call HT_fnc_getStatus] call CBA_fnc_publicVariable;
    ...
    if (["WEST"] call HT_fnc_canRespawn) then {
...
//OPFOR ========================================================================
[{
    ["WAVERESPAWNSTATUSOPF",[EAST] call HT_fnc_getStatus] call CBA_fnc_publicVariable;
    ...
    //enable respawning when wave is full
    if (["EAST"] call HT_fnc_canRespawn) then {
...
//INDEP ========================================================================
[{
    ["WAVERESPAWNSTATUSIND",[INDEPENDENT] call HT_fnc_getStatus] call CBA_fnc_publicVariable;
    ...
    //enable respawning when wave is full
    if (["INDEPENDENT"] call HT_fnc_canRespawn) then {
